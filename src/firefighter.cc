...
int main(int argc, char **argv)
{
    ...
    std::string transformJsonFilePath = "./src/conductor/example/json/fire_transforms.json"; // 修改为你的 JSON 文件路径

    FrameManager transformManager(transformJsonFilePath);

    std::string waypointJsonFilePath = "./src/conductor/example/json/fire_waypoint.json"; // 修改为你的 JSON 文件路径
